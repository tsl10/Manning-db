  ...
  <ul class="navbar-nav ml-auto">
    ...
    <?php if (Session::get('id') == TRUE) { ?>
      <?php if (Session::get('roleid') == '1') { ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="alluserdata.php"><i class="fas fa-users mr-2"></i>all user data </a>
        </li>
        <li class="nav-item
        <?php
      ...
      <!-- Only show Upload CV for non-admin users -->
      <?php if (Session::get('roleid') != '1') { ?>
        <li class="nav-item">
          <a class="nav-link" href="form.html"><i class="fas fa-upload"></i> Upload CV</a>
        </li>
      <?php } ?>
    ...
    <?php } else { ?>
      ...
      ?>">
        <a class="nav-link" href="login.html"><i class="fas fa-sign-in-alt mr-2"></i>Login</a>
      </li>
